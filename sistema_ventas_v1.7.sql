/*Modificaciones de la Version 1.6
    -Se modifica longitud descripcion en producto a 90
    -Se agregan los insert de Empleado, Productos, Tipo Producto, Categoria
   
*/

-- DROP database IF EXISTS `sistema_ventas_java`
...
--
-- Host: localhost    Database: java_mozzi_ferullo_milloni
-- ------------------------------------------------------
...
/*INSERT INTO empleado(nombre, apellido, telefono, email, direccion, dni, idRol, password) VALUES('Manuel', 'Milloni', '3413567882', 'manuel-milloni@hotmail.com.ar', 'Mendoza 3456', '37456298','1','C/DZ9XrfdBvdCVvUXDSnZg==');
COMMIT; */
...
LOCK TABLES `empleado` WRITE;
/*!40000 ALTER TABLE `empleado` DISABLE KEYS */;
INSERT INTO empleado (nombre, apellido, telefono, email, direccion, dni, idRol, password) VALUES ('Manuel','Milloni','3413567882','manuel-milloni@hotmail.com.ar','Mendoza 3456','37456298',1,'C/DZ9XrfdBvdCVvUXDSnZg=='),('Feliciano','Mozzi','3329405244','felicianomozzi02@gmail.com','Moreno 1358','44114394',1,'C/DZ9XrfdBvdCVvUXDSnZg=='),('Matías','Ferullo','3482539522','matias.ferullo1@gmail.com','Rioja 1234','43214321',1,'C/DZ9XrfdBvdCVvUXDSnZg=='),('Claudio','Mozzi','3329581427','claudiomozzi@gmail.com','Saavedra 473','16301960',2,'C/DZ9XrfdBvdCVvUXDSnZg=='),('Sergio','Rochetti','3329151515','sergiorochetti@gmail.com','Castro 1145','16444185',2,'C/DZ9XrfdBvdCVvUXDSnZg==');
/*!40000 ALTER TABLE `empleado` ENABLE KEYS */;
UNLOCK TABLES;
