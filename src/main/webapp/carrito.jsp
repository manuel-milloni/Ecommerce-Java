	...
	<div class="container">
		...
		<div class="d-flex py-3">
			...
			<a class="mx-3 btn btn-primary"
				href="ControladorVenta?menu=venta&accion=nuevaVenta">Confirmar
				pedido</a>
		...
		<table class="table table-loght">
			...
			<tbody>
				...
				<tr>
					...
					<td><%=c.getPrecio()*c.getCantidad()%></td>
					<td>
						<form action="" method="post" class="form-inline">
							...
							<div
								...
								<a class="btn btn-sm btn-decre"
									href="ControladorCarrito?menu=carrito&accion=decrementar&id=<%=c.getIdProducto()%>"><i
								...
								<a class="btn btn-sm btn-incre"
									href="ControladorCarrito?menu=carrito&accion=incrementar&id=<%=c.getIdProducto()%>"><i
					...
					<td><a class="btn btn-sm btn-danger"
						href="ControladorCarrito?menu=carrito&accion=eliminar&id=<%=c.getIdProducto()%>">Eliminar</a>
