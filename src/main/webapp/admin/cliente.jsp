	...
	<div class="d-flex">
		...
		<div class="card col-sm-4">
			...
			<div class="card-body">
				...
				<form action="ControladorCliente?menu=Cliente&accion=NuevoCliente"
					method="post">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" id="nombre" name="nombre" class="form-control"
								value="${cli.getNombre()}" maxlength="30" required>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" id="apellido" name="apellido"
								class="form-control" value="${cli.getApellido()}" maxlength="30"
								required>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" id="telefono" name="telefono"
								class="form-control" value="${cli.getTelefono()}" maxlength="30"
								required>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="email" id="email" name="email" class="form-control"
								value="${cli.getEmail()}" maxlength="50" required>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" id="direccion" name="direccion"
								class="form-control" value="${cli.getDireccion()}"
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" id="cuit" name="cuit" class="form-control"
								value="${cli.getCuit()}" maxlength="30" required>
						</div>
					</div>
							...
							<select id="categoria" name="categoria" class="form-control"
								...
								<c:forEach var="cat" items="${categorias}">
									<option value="${cat.getId()}"
										${cat.getDescripcion() eq opcion ? 'selected' : ''}>${cat.getDescripcion()}</option>
								</c:forEach>
							</select>
						</div>
					</div>
					...
					<div class="form-group row">
						<label for="password_2" class="col-sm-3 col-form-label">Repita
							Contraseña:</label>
						<div class="col-sm-9">
				...
				<tbody>
					<tr>
						...
						<td><a class="btn btn-warning"
							href="ControladorCliente?menu=Cliente&accion=Editar&id=<%=c.getId()%>">Editar</a>
							<a class="btn btn-danger"
							href="ControladorCliente?menu=Cliente&accion=Eliminar&id=<%=c.getId()%>">Eliminar</a>
						</td>
