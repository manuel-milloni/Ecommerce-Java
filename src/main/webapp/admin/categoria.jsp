...
<body>
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        ...
        <form action="ControladorCategoria?menu=Categoria&accion=NuevoCategoria" method="post">
            
            <div class="form-group row">
                <label for="descripcion" class="col-sm-3 col-form-label">Descripción:</label>
            <div class="col-sm-9">
            <input type="text" id="descripcion" name="descripcion" class="form-control" value="${categoria.getDescripcion()}" maxlength="30" required>
            </div>
            </div>
            <br>
