...
<body>
    ...
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        ...
        <form action="ControladorEmpleado?menu=Empleado&accion=NuevoEmpleado" method="post">
            
            <div class="form-group row">
                <label for="nombre" class="col-sm-3 col-form-label">Nombre:</label>
            <div class="col-sm-9">
            <input type="text" id="nombre" name="nombre" class="form-control" value="${emp.getNombre()}" maxlength="30" required>
            </div>
            </div>
            ...
            <div class="col-sm-9">
            <input type="text" id="apellido" name="apellido" class="form-control" value="${emp.getApellido()}" maxlength="30" required>
            </div>
            </div>
            ...
            <div class="col-sm-9">
            <input type="text" id="telefono" name="telefono" class="form-control" value="${emp.getTelefono()}" maxlength="30" required>
            </div>
            </div>
            ...
            <div class="col-sm-9">
            <input type="email" id="email" name="email" class="form-control" value="${emp.getEmail()}" maxlength="50" required>
            </div>
            </div>
            ...
            <div class="col-sm-9">
            <input type="text" id="direccion" name="direccion" class="form-control" value="${emp.getDireccion()}" required>
            </div>
            </div>
            ...
            <div class="col-sm-9">
            <input type="text" id="dni" name="dni" class="form-control" value="${proveedor.getDni()}" maxlength="30" required>
            </div>
            </div>
            ...
            <table class="table table-hover">
                ...
                <% 
                    ...
                    for(Empleado empleado: empleados){
                     rol=rDAO.getById(empleado.getIdRol());
                     %> <tbody>
                        <tr>
                            ...
                            <td>
                            <a class="btn btn-warning" href="ControladorEmpleado?menu=Empleado&accion=Editar&id=<%=empleado.getId()%>">Editar</a>
                            <a class="btn btn-danger" href="ControladorEmpleado?menu=Empleado&accion=Eliminar&id=<%=empleado.getId()%>">Eliminar</a>
                        </td>
