...
<body>
    ...
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        ...
        <form action="ControladorProveedor?menu=Proveedor&accion=NuevoProveedor" method="post">
            ...
            <div class="col-sm-9">
            <input type="email" id="email" name="email" class="form-control" value="${proveedor.getEmail()}" required>
            </div>
            </div>
