	...
	<div class="d-flex">
		...
		<div class="card col-sm-4">
			...
			<div class="card-body">
				...
				<form
					action="Controlador?menu=Producto&accion=modificar&id=${producto.getIdProducto()}"
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" id="descripcion" name="descripcion"
								class="form-control" value="${producto.getDescripcion()}"
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="number" id="precio" name="precio"
								class="form-control" value="${producto.getPrecio()}" required
								step="any">
						</div>
					</div>
						...
						<div class="col-sm-9">
							<select id="tipoProducto" name="tipoProducto"
								...
								<c:forEach var="tp" items="${tiposProducto}">
									<option value="${tp.getIdTipo()}"
										${tp.getDescripcion() eq opcion ? 'selected' : ''}>${tp.getDescripcion()}</option>
								</c:forEach>
							</select>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="number" id="stock" name="stock" class="form-control"
								value="${producto.getStock()}" required step="1">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="text-center">
						<a class="btn btn-warning"
							href="Controlador?menu=Producto&accion=Producto">Cancelar</a> <input
							class="btn btn-success" type="submit" value="Modificar">
				...
				<tbody>
					<tr>
						...
						<td><a class="btn btn-warning"
							...
							href="Controlador?menu=Producto&accion=Eliminar&id=<%=p.getIdProducto()%>">Eliminar</a>
						</td>
