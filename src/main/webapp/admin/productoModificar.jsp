...
<body>
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        ...
        <form action="Controlador?menu=Producto&accion=modificar&id=${producto.getIdProducto()}" method="post" enctype="multipart/form-data">
            
            <div class="form-group row">
                <label for="descripcion" class="col-sm-3 col-form-label">Descripción:</label>
            <div class="col-sm-9">
            <input type="text" id="descripcion" name="descripcion" class="form-control" value="${producto.getDescripcion()}" maxlength="30" required>
            </div>
            </div>
        ...
        <div class="col-sm-9">
        <input type="number" id="precio" name="precio" class="form-control" value="${producto.getPrecio()}" required step="any">
        </div>
         </div>
      ...
      <div class="col-sm-9">
        <input type="file" name="imagen" id="imagen" accept="image/*" >
            ...
            <div class="text-center">
                <a class="btn btn-warning" href="Controlador?menu=Producto&accion=Producto">Cancelar</a>
