...
<body>
	...
	<div class="container text-center">
		<div class="row mt-3">
			<div class="col-12">
				<form action="ControladorInicio?menu=inicio&accion=buscador"
					method="post">
		...
		<div class="row">
			...
			<div class="col-md-3 my-3">
				<div class="card w-100" style="width: 18rem;">
					<img class="card-img-top" src="<%=p.getImagen()%>"
						alt="Imagen producto" width="200" height="200">
					<div class="card-body">
						<h5 class="card-title">
							<%=p.getDescripcion()%></h5>
						<h6 class="price">
						...
						<div class="mt-3 d-flex justify-content-between">
							<a
								href="ControladorCarrito?menu=carrito&accion=agregar&id=<%=p.getIdProducto()%>"
