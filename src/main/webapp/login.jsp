    ...
    <body>
        ...
        <% } %>
            ...
            <div class="card w-50 mx-auto my-5">
                ...
                <div class="card-body">
                    <form action="ControladorLogin?menu=login&accion=loginCliente" method="post">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="ControladorLogin?menu=login&accion=registro" class="btn btn-primary">Regristrarse</a>
